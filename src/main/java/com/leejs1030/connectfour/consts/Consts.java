...
public interface Consts {
    ...
    int AI_COL_TWO_SCORE = 60, AI_COL_THREE_SCORE = 180;
    int AI_DIA_TWO_SCORE = 60, AI_DIA_THREE_SCORE = 180;

    int PLAYER_ROW_TWO_SCORE = -90, PLAYER_ROW_THREE_SCORE = -200;
    int PLAYER_COL_TWO_SCORE = -90, PLAYER_COL_THREE_SCORE = -200;
    int PLAYER_DIA_TWO_SCORE = -90, PLAYER_DIA_THREE_SCORE = -200;

    int AI_GOOD_THREE = 1000000, AI_BAD_THREE = 900, AI_GOOD_TWO = 600, AI_TWO = 600, AI_BAD_TWO = 0;
    int PLAYER_GOOD_THREE = -100000, PLAYER_BAD_THREE = -900, PLAYER_GOOD_TWO = -450, PLAYER_TWO = 450, PLAYER_BAD_TWO = -0;
}
